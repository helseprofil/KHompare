...
**\_PCT** respectively. The column **\_OUT** indicate the measurement variables
that are of extreme values ie. outlier. The value for outlier is either **1**
for *lower* or **2** upper outlier.
